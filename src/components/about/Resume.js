...
export default function Resume(props) {
  const { data } = props;
  console.log(data)
  const profileImgSrc = data.allFile.edges[0].node.childImageSharp.fluid;
  return (
    <Container className="resume" fluid>
      <Row>
        <Col xs={3} className="p-4">
          <Img fluid={profileImgSrc} alt="profile-img" className="profile-image" />
        </Col>
      ...
      <Row className="personal-details justify-content-between">
        ...
        <div className="personal-detail d-flex flex-column align-items-start px-3">
          <p>C/5/1, Block C, Baghajatin, Kolkata - 700092</p>
          <p>WB, India</p>
        </div>
      </Row>
